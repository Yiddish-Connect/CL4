                ...
                child: Center(
                  child: Stack(
                    children: [
                      // The animated curve
                      Align(
                          alignment: Alignment.center, child: AnimatedCurve()),
                      // The user avatar 1
                      Positioned(
                          top: 100,
                          left: 40,
    ...
    return ElevatedButton(
        ...
        child: Row(
          ...
          children: [
            Image(
              image: AssetImage(
                  'assets/google_icon@2x.png'), // Path to your Google icon file
              height: 40.0,
              width: 40.0,
            ),
            SizedBox(width: 8.0),
    ...
    return ElevatedButton(
        ...
        child: Row(
          ...
          children: [
            Image(
              image: AssetImage(
                  'assets/apple_icon@2x.png'), // Path to your Google icon file
              height: 40.0,
              width: 40.0,
            ),
            SizedBox(width: 8.0),
